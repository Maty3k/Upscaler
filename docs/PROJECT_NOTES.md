...
| — | **Blur** tab + `upscaler blur` — 8 blur kinds (gaussian/box/motion/spin/zoom/lens/pixelate/surface) through whole/rectangle/ellipse/band/painted masks with feather + graded ramp; pure PIL/numpy | `blur.py` |
